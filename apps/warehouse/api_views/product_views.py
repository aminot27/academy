...
class ProductView(BaseAPIView):
    permission_classes = [IsAuthenticated]
    product_repository = ProductRepository()
    parser_classes = (MultiPartParser, FormParser)  # Asegúrate de que la clase pueda manejar la carga de archivos
    ...
    def post(self, request):
        ...
        # Aquí manejas la imagen
        if 'image' in request.FILES:
            create_data['image'] = request.FILES['image']
